...
class BookingAppointmentIntroduction extends StatelessWidget {
  final AnimationController animationController;

  const BookingAppointmentIntroduction({Key? key, required this.animationController})
      : super(key: key);
            ...
            children: [
              ...
              SlideTransition(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    "Let us handle the tedious task of managing your health appointments.",
              ...
              SlideTransition(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/introduction/booking appointments.png',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
